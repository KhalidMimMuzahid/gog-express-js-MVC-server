...
const uri = `mongodb+srv://${process.env.DB_USER}:${process.env.DB_PASS}@cluster0.pr2sb9x.mongodb.net/?retryWrites=true&w=majority`;
...
async function run(){
  try{
    ...
    // collection 1 
    const usersCollection = client.db('geeksOfGurukul').collection('usersCollection');
    const applyDataCollection = client.db('geeksOfGurukul').collection('usersApplyDataCollection');
